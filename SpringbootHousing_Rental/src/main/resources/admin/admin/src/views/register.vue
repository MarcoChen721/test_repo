  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 1);borderRadius:10px">
        <h1 class="h1" style="color:rgba(131, 138, 182, 1);fontSize:28px;">租房网站注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("https://img0.baidu.com/it/u=376567532,1775150091&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=333");
		height: 100vh;
